...
Docker Compose is VYRA's canonical reproducible local integration environment. Phase 3A contains an Octane + FrankenPHP application service, PostgreSQL, and Redis. Queue workers, Laravel Reverb, SSR, and specialist services are optional and added only when their feature work is approved.
